...
import noticeModal from "../../../../../assets/noticeModal02.png";
...
export const GoalCardModal: React.FC<GoalCardModalProps> = ({ isOpen, onClose }) => {
                  ...
                  <>
                    ...
                    <div className="mb-[4%]">
                      ...
                      <p className="[font-family:'Pretendard',sans-serif] font-medium text-white text-[18px] leading-[1.5] mb-[1%]">
                        위 '목표' 활동을 택한 경우, 앞으로의 1주일의 클럽 활동 중
                        이 활동을 '목표'로 선정한 이유와 1주일 후 해당 목표의 달성 여부를 판가름 하는 시점에 있을
                        미래의 본인에게 보내는 각오 메시지를 작성해주세요!
                      </p>
